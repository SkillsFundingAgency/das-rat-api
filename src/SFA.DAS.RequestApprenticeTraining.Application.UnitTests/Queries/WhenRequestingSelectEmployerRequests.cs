...
namespace SFA.DAS.RequestApprenticeTraining.Application.UnitTests.Queries
{
    public class WhenRequestingSelectEmployerRequests
    {
        ...
        [Test, AutoMoqData]
        public async Task And_SelectEmployerRequests_IsContactedByThisProviderWithin12MonthsTrue_ThenSelectEmployerRequestsAreReturned(
            [Frozen(Matching.ImplementedInterfaces)] RequestApprenticeTrainingDataContext context)
        {
            // Arrange
            var ukprn = 789456;
            ...
            context.Add(new RequestType { Id = 1, Description = "Shortlist" });
            context.Add(new Standard { StandardReference = standard1Reference, StandardTitle = standard1Title, StandardLevel = 1, StandardSector = "Sector 1" });
            var employerRequest1 = context.Add(new EmployerRequest { Id = Guid.NewGuid(), AccountId = 1, RequestedAt = DateTime.Now.AddMonths(-5), StandardReference = standard1Reference, NumberOfApprentices = 1, AtApprenticesWorkplace = false, BlockRelease = true, DayRelease = false, RequestStatus = Domain.Models.Enums.RequestStatus.Active });
            ...
            [Frozen(Matching.ImplementedInterfaces)] RequestApprenticeTrainingDataContext context)
        {
            ...
            context.Add(new Standard { StandardReference = standard1Reference, StandardTitle = standard1Title, StandardLevel = 1, StandardSector = "Sector 1" });
            var employerRequest1 = context.Add(new EmployerRequest { Id = Guid.NewGuid(), AccountId = 1, RequestedAt = DateTime.Now.AddMonths(-5), StandardReference = standard1Reference, NumberOfApprentices = 1, AtApprenticesWorkplace = false, BlockRelease = true, DayRelease = false, RequestStatus = Domain.Models.Enums.RequestStatus.Active });
            var employerRequest2 = context.Add(new EmployerRequest { Id = Guid.NewGuid(), AccountId = 2, RequestedAt = DateTime.Now.AddMonths(-13), StandardReference = standard1Reference, NumberOfApprentices = 2, AtApprenticesWorkplace = true, BlockRelease = false, DayRelease = true, RequestStatus = Domain.Models.Enums.RequestStatus.Active });
        ...
        [Test, AutoMoqData]
        public async Task And_SelectEmployerRequests_IsContactedTrue_RequestedOver12MonthsTrue_ThenSelectEmployerRequestsAreNotReturned(
            [Frozen(Matching.ImplementedInterfaces)] RequestApprenticeTrainingDataContext context)
        {
            // Arrange
            var ukprn = 789456;
            ...
            context.Add(new RequestType { Id = 1, Description = "Shortlist" });
            context.Add(new Standard { StandardReference = standard1Reference, StandardTitle = standard1Title, StandardLevel = 1, StandardSector = "Sector 1" });
            var employerRequest1 = context.Add(new EmployerRequest { Id = Guid.NewGuid(), AccountId = 1, RequestedAt = DateTime.Now.AddMonths(-12).AddHours(-1), StandardReference = standard1Reference, NumberOfApprentices = 1, AtApprenticesWorkplace = false, BlockRelease = true, DayRelease = false, RequestStatus = Domain.Models.Enums.RequestStatus.Active });
