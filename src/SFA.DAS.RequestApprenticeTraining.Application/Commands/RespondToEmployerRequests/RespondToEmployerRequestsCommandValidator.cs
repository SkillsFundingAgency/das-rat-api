...
{
    public class RespondToEmployerRequestsCommandValidator : AbstractValidator<RespondToEmployerRequestsCommand>
    {
        public RespondToEmployerRequestsCommandValidator()
        {
