...
```bash
./SqlPackage /Action:Publish /SourceFile:bin/Debug/RequestApprenticeTraining.Database.dacpac /TargetServerName:localhost /TargetDatabaseName:RequestApprenticeTraining.Database
```
